...
class QuestionContent extends StatefulWidget {
  ...
  QuestionContent({required this.questionsubject});
...
class _QuestionContentState extends State<QuestionContent> {
          ...
          child: Column(
            ...
            children: [
                Padding(
                  ...
                  child: appbarlike(text: 'Question Content',)
                ),
                 Padding(
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                    Text('Question',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16,color: Colors.white)),
                    SizedBox(height: Dimensions.height10,),
                ...
                Row(
                  ...
                  children: [
                    Text("Answers",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16)),
                ButtonWidget(
                text: 'Add Answer',
                onClicked: () async {
                    final youranswer = await opendialog();
                    if(youranswer==null || youranswer.isEmpty) return;

                    setState(() {
                      answers.add(youranswer);
                    });
                    controller.clear();
  ...
  Padding Answer(List answersShown,int position) {
    return Padding(
      padding: EdgeInsets.symmetric(vertical : Dimensions.height10),
      child: Container(
                  decoration: BoxDecoration(
