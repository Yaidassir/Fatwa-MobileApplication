                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: const [
                                  Text("YAIDASSIR YAIDASSIR",style: TextStyle(fontSize: 14),),
                                  Text("Have published a post that you may like",style: TextStyle(color: Colors.grey,fontSize: 12.0),),
                                  Text("12:22",style: TextStyle(fontSize: 12,color: Colors.grey),)
                                ],
                              ),
                            ),
                          )
