...
import 'package:fatwa/Screens/HomePage/Home_Fatwa/CustomSearchDelegate.dart';
                      ...
                      Expanded(
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(20),
                              color: buttoncolor? Color.fromARGB(61, 142, 202, 230) : Colors.transparent,
                            ),
                            child: Center(child: Text("Fatawas")),
                          ),
                        ),
                      ),
                      Expanded(
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(20),
                              color: buttoncolor? Colors.transparent: Color.fromARGB(61, 142, 202, 230),
                            ),
                            child: Center(child: Text("Les Plus lus")),
                          ),
                        ),
                      ),
...
class PageTitle extends StatelessWidget {
  String pagetitle;
   PageTitle({Key? key,required this.pagetitle}) : super(key: key);
    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          gradient : LinearGradient(colors: [Color.fromARGB(255, 96, 192, 99),Color.fromARGB(255, 1, 162, 184)]),
        ),
        child: Padding(
            ...
            mainAxisAlignment: MainAxisAlignment.center,
             children :[
                 Expanded(child: Text(textAlign:TextAlign.center
                   ,pagetitle,style: TextStyle(color: Colors.white,fontSize: 26,fontWeight:FontWeight.bold),)), 
                SizedBox(width: Dimensions.width10,),
                // SvgPicture.asset('../../../../assets/icons/mosque-svgrepo-com.svg',color: Colors.white,width: 26,height: 26,)
                  ]),
        ),
      ),
    );
...
class PageHeaderProfilePicture extends StatelessWidget {
  String pagetitle = "";
            ...
            children: [      
              ...
              SizedBox(width: Dimensions.width20,),
               Column(
                children: [
                  Text("مرحبا بك"),
                  Text('جمال الدين',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
